...
public class ClientMachine {
    ...
    public static void main(String[] args) {
        try {
            IDao<Machine> machieDao = (IDao<Machine>) Naming.lookup("rmi://localhost:8080/machineDao");
            IDao<Salle> salleDao = (IDao<Salle>) Naming.lookup("rmi://localhost:8080/salleDao");
